...
const HomeServicesShortDetails = () => {
    return (
        <div>
            <h1 className='text-center text-4xl mt-20'>Our Services</h1>
            <div className='services-div grid grid-cols-3'>

                <div className="card w-96 bg-base-100 gh">

                    <figure className="px-10 pt-10">
                        <img src="https://placeimg.com/400/225/arch" alt="Shoes" className="w-60" />
                    </figure>
